...
#COPIE COLLE de ARM_MUSCA.py ! To change
...
MBED_OS_ROOT = abspath(path_join(SCRIPT_DIR, os.pardir, os.pardir,os.pardir,os.pardir,os.pardir))
...
def stm32l552ze_q_tfm_hex(t_self, non_secure_bin, secure_bin, target_name):
    ...
    mcuboot_bin = path_join(STM32L552ZE_Q_S_BASE, 'bl2.bin')
    image_macros_s = path_join(STM32L552ZE_Q_S_BASE, 'partition', 'signing_layout_s.c')
    image_macros_ns = path_join(STM32L552ZE_Q_S_BASE, 'partition', 'signing_layout_ns.c')
    ...
    cmd = [
        ...
        '1.4.0',
        "-k",
        path_join(SCRIPT_DIR,'root-rsa-3072.pem'),
        "--layout",
        image_macros_s,
        "--public-key-format",
        'full',
